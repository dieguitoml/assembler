...
(func $function	(param $dirinstancia i32)	(result i32)
 ...
 ;; DeclaracionFuncion (TipoVoid(),Identificador(main),BloqueInteriorFuncion ([], BloqueFuncion (DeclaracionVariableConAsign(TipoInt(),Identificador(i),InstruccionLlamadaFuncion (Identificador(function),[])),InstruccionCOUT(Identificador(i)),return void)))
(func $main	(param $dirinstancia i32)	
    ;; DeclaracionVariableConAsign(TipoInt(),Identificador(i),InstruccionLlamadaFuncion (Identificador(function),[]))
    global.get $MP
    i32.const 8
    i32.add
    i32.store
